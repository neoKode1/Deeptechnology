    ...
    <div className="min-h-screen bg-white text-[#333]">
      <div className="max-w-3xl mx-auto px-6 md:px-12 py-24">
        ...
        <div className="flex flex-col gap-8 text-base leading-relaxed">
          ...
          <section>
            <h2 className="font-manrope font-semibold text-lg text-[#111] mb-3">4. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="font-manrope font-semibold text-lg text-[#111] mb-3">5. Third-Party Services</h2>
          ...
          <section>
            <h2 className="font-manrope font-semibold text-lg text-[#111] mb-3">6. Modifications</h2>
