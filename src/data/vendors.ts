...
export const VENDORS: Vendor[] = [
  ...
  // ─── COBOTS / ROBOT ARMS ────────────────────────────────────────────────────
  {
    ...
    products: [
      { name: 'UR3e', price: '$23,000–$30,000', status: 'quote_required', notes: '3 kg payload; 500 mm reach; bench-top assembly and testing.', image: '/media/Universal%20Robots.png' },
      { name: 'UR5e', price: '$30,000–$45,000', status: 'quote_required', notes: '5 kg payload; 850 mm reach; machine tending, packaging, pick-and-place.', image: '/media/Universal%20Robots.png' },
      { name: 'UR10e', price: '$45,000–$55,000', status: 'quote_required', notes: '12.5 kg payload; 1300 mm reach; most popular model.', image: '/media/Universal%20Robots.png' },
      { name: 'UR16e', price: '~$55,000', status: 'quote_required', notes: '16 kg payload; 900 mm reach; high-payload close-range tasks.', image: '/media/Universal%20Robots.png' },
      { name: 'UR20', price: '$65,000–$85,000+', status: 'quote_required', notes: '20 kg payload; 1750 mm reach; palletizing, welding, material handling.', image: '/media/Universal%20Robots.png' },
      { name: 'UR30', price: 'Quote required', status: 'quote_required', notes: '30 kg payload; heavy-payload compact cobot; newest model.', image: '/media/Universal%20Robots.png' },
    ],
  ...
  },
  {
    ...
    products: [
      { name: 'CRX-5iA', price: 'Quote', status: 'quote_required', notes: '5 kg payload; 994 mm reach; beginner-friendly teach pendant.', image: '/media/FANUC.jpeg' },
      { name: 'CRX-10iA', price: 'Quote', status: 'quote_required', notes: '10 kg payload; 1249 mm reach; versatile assembly and machine tending.', image: '/media/FANUC.jpeg' },
      { name: 'CRX-10iA/L', price: 'Quote', status: 'quote_required', notes: '10 kg payload; 1418 mm extended reach.', image: '/media/FANUC.jpeg' },
      { name: 'CRX-20iA/L', price: 'Quote', status: 'quote_required', notes: '20 kg payload; 1418 mm reach; heavier part handling.', image: '/media/FANUC.jpeg' },
      { name: 'CRX-25iA', price: '~$63,776', status: 'quote_required', notes: '25 kg payload; 1889 mm reach; palletizing and heavy tasks.', image: '/media/FANUC.jpeg' },
      { name: 'CRX-30iA', price: 'Quote', status: 'quote_required', notes: '30 kg payload; largest CRX cobot; heavy industrial collaboration.', image: '/media/FANUC.jpeg' },
    ],
  ...
  },
  {
    ...
    products: [
      { name: 'LBR iiwa 7 R800', price: 'Quote', status: 'quote_required', notes: '7 kg payload; 800 mm reach; 7-axis; torque sensing all joints; automotive + electronics.', image: '/media/KUKA.avif' },
      { name: 'LBR iiwa 14 R820', price: 'Quote', status: 'quote_required', notes: '14 kg payload; 820 mm reach; 7-axis; heavy part assembly.', image: '/media/KUKA.avif' },
      { name: 'LBR iisy 3 R760', price: 'Quote', status: 'quote_required', notes: '3 kg payload; 760 mm reach; 6-axis cobot; easy setup.', image: '/media/KUKA.avif' },
      { name: 'LBR iisy 8 R930', price: 'Quote', status: 'quote_required', notes: '8 kg payload; 930 mm reach; 6-axis; machine tending.', image: '/media/KUKA.avif' },
      { name: 'LBR iisy 11 R1300', price: 'Quote', status: 'quote_required', notes: '11 kg payload; 1300 mm reach; extended-reach tasks.', image: '/media/KUKA.avif' },
      { name: 'LBR iisy 15 R930', price: 'Quote', status: 'quote_required', notes: '15 kg payload; 930 mm reach; highest payload iisy cobot.', image: '/media/KUKA.avif' },
      { name: 'LBR Med 14 R820', price: 'Quote', status: 'quote_required', notes: '14 kg payload; medical-certified variant; ISO 10218 + IEC 62061.', image: '/media/KUKA.avif' },
    ],
  ...
  },
  {
    ...
    products: [
      { name: 'Franka Research 3 (FR3)', price: '~$25,000', status: 'in_stock', orderUrl: 'https://franka.de', notes: '7-DOF; 3 kg payload; 855 mm reach; torque sensors all 7 joints; ±0.1 mm repeatability; ROS2/MATLAB compatible.', image: '/media/Franka%20Robotics-franka-research-3.png' },
      { name: 'FR3 Arm v2 (Upgrade)', price: 'Quote', status: 'quote_required', notes: 'Latest hardware revision; enhanced usability; continuous OTA updates.', image: '/media/Franka%20Robotics-franka-research-3.png' },
      { name: 'Franka AI Companion', price: 'Quote', status: 'quote_required', notes: 'AI-native software layer for autonomous task learning on FR3.', image: '/media/Franka%20Robotics-franka-research-3.png' },
      { name: 'Franka Hand (FE Gripper)', price: '~$1,704', status: 'in_stock', orderUrl: 'https://franka.de', notes: 'Factory-integrated parallel gripper for FR3; programmable force/width.', image: '/media/Franka%20Robotics-franka-research-3.png' },
    ],
  ...
  // ─── SURGICAL / MEDICAL ─────────────────────────────────────────────────────
  {
    ...
    products: [
      { name: 'da Vinci 5', price: '$1,800,000–$2,500,000', status: 'quote_required', image: '/media/Intuitive%20Surgical.jpeg' },
      { name: 'da Vinci Xi', price: 'Quote', status: 'quote_required', image: '/media/Intuitive%20Surgical.jpeg' },
      { name: 'da Vinci SP (single port)', price: 'Quote', status: 'quote_required', image: '/media/Intuitive%20Surgical.jpeg' },
    ],
  ...
  },
  {
    ...
    products: [
      { name: 'Agras T10', price: '~$10,000', status: 'in_stock', orderUrl: 'https://store.dji.com/category/agriculture', notes: '10 L tank; 8-nozzle; compact for small farms.', image: '/media/DJI%20Agras-Dronak_nekazaritzan_%28cropped%29.jpg' },
      { name: 'Agras T25', price: '$17,999', status: 'in_stock', orderUrl: 'https://store.dji.com/category/agriculture', notes: '20 L tank; 16-nozzle; mid-range spraying drone.', image: '/media/DJI%20Agras-Dronak_nekazaritzan_%28cropped%29.jpg' },
      ...
      { name: 'Agras T50 (Spreading)', price: '$31,999', status: 'in_stock', orderUrl: 'https://store.dji.com/category/agriculture', notes: 'Spreader payload variant for fertilizer/seed spreading.', image: '/media/DJI%20Agras-Dronak_nekazaritzan_%28cropped%29.jpg' },
    ],
  ...
  },
  {
    ...
    products: [
      { name: 'REVOLUTION ROV', price: '$15,000–$60,000', status: 'in_stock', orderUrl: 'https://deeptrekker.com', image: '/media/Deep%20Trekker-REV_front__1_.jpg' },
      { name: 'DTG3', price: 'Quote', status: 'quote_required', image: '/media/Deep%20Trekker.png' },
      { name: 'PIVOT', price: 'Quote', status: 'quote_required', image: '/media/Deep%20Trekker.png' },
    ],
