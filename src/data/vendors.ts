...
export const VENDORS: Vendor[] = [
  // ─── HUMANOID ───────────────────────────────────────────────────────────────
  {
    ...
    contacts: [
      ...
      { label: 'US Dealer — ToborLife', value: 'Mountain View, CA', href: 'https://toborlife.ai/showroom/' },
  ...
  },
  {
    ...
    products: [
      { name: 'Kiwibot Leap', price: '$899/mo per robot', deposit: '$100 refundable', status: 'pre_order', orderUrl: 'https://www.robot.com/', notes: 'US only, limited units. Kiwibot rebranded to robot.com.', image: '/media/kiwi-2.webp' },
    ],
  ...
  // ─── DRONES ─────────────────────────────────────────────────────────────────
  {
    ...
    products: [
      ...
      { name: 'Matrice 3TD', price: '~$5,799', status: 'in_stock', orderUrl: 'https://enterprise.dji.com', notes: 'Triple-sensor enterprise compact: 48MP wide (4/3 CMOS) + 12MP 4× optical zoom tele + 640×512 LWIR thermal; 45-min flight; IP55; O3 Enterprise 15 km; 920g; omnidirectional obstacle sensing; hot-swappable battery. Ideal for inspection and first response.', image: '/media/DJI%20Matrice%203TD.webp' },
  ...
  },
  {
    ...
    products: [
      { name: 'Skydio X10', price: 'Quote (~$11K est.)', status: 'quote_required', orderUrl: 'https://www.skydio.com/x10', notes: 'Flagship enterprise drone. NDAA compliant; US-assembled. 45 mph max speed; 40-min flight time; IP55 weatherproofing; NVIDIA Jetson Orin AI onboard; 4-bay modular payload system (EO, IR, spotlight). Used by public safety, utilities, infrastructure inspection.', image: '/media/Skydio.avif' },
      { name: 'Skydio X10D (Defense)', price: 'Quote — DOD/Federal only', status: 'quote_required', orderUrl: 'https://www.skydio.com/x10d', notes: 'Defense-hardened X10 variant. EW-resilient; Blue UAS cleared; GPS-denied navigation; battlespace sUAS. Federal/DOD procurement only. NDAA Section 848 compliant.', image: '/media/Skydio.avif' },
      { name: 'Skydio R10', price: 'Quote (~$12–15K est.)', status: 'pre_order', orderUrl: 'https://www.skydio.com/r10', notes: 'NEW · First US-purpose-built indoor drone for public safety and confined-space operations. 785g (1.73 lbs); 20-min flight time; Perch Mode up to 3 hours of stationary streaming; 30-second deployment from case; Qualcomm Snapdragon 865 SoC; 27 mph max; operates -20°C to +50°C; encrypted telemetry and media; CJIS-compliant cloud. Early access fall 2025; GA 2026.', image: '/media/Skydio.avif' },
      { name: 'Skydio F10', price: 'Quote (~$15–20K est.)', status: 'pre_order', orderUrl: 'https://www.skydio.com/f10', notes: 'COMING SOON · Fully autonomous fixed-wing drone. >80 mph speed; >90-min flight time; 4.9 kg; 120 cm wingspan; designed for long-range infrastructure, borders, and wide-area coverage. Dock-integrated for fully automated BVLOS sorties. NDAA compliant; US-assembled. Early access H1 2026.', image: '/media/Skydio.avif' },
      { name: 'Skydio Dock for X10', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.skydio.com/dock', notes: 'Weatherproof drone-in-a-box for X10. Remotely operated from anywhere; fully automated BVLOS inspection; supports 24/7 autonomous operations. Pairs with Remote Ops and DFR Command software.', image: '/media/Skydio.avif' },
      { name: 'DFR Command (Software)', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.skydio.com/software/dfr-command', notes: 'Drone as First Responder command and control software. Integrates with CAD/dispatch systems; real-time video streaming; fleet management for public safety agencies.', image: '/media/Skydio.avif' },
      { name: 'Remote Ops (Software)', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.skydio.com/software/remote-ops', notes: 'Remote operations platform. Control Skydio drones and Docks from anywhere; live video feeds; mission planning; data export to downstream workflows.', image: '/media/Skydio.avif' },
      { name: '3D Scan (Software)', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.skydio.com/software/3D-scan', notes: 'Automated 3D scanning software. AI-driven flight paths capture complete photogrammetric datasets of structures, infrastructure, and terrain. Integrates with Autodesk, Bentley, and other platforms.', image: '/media/Skydio.avif' },
    ],
    procurementNotes: 'Skydio (San Mateo, CA) is America\'s leading drone manufacturer — designed, assembled, and supported in the USA. No public pricing; all products require contacting sales or an authorized distributor. RMUS and ADS handle civilian and government/DOD channels respectively. NDAA-compliant across the lineup. Deployed by 1,500+ public safety agencies, utilities, and enterprise customers. X10 is the current flagship; R10 (indoor) and F10 (fixed-wing) are the next-gen additions announced at Ascend 2025.',
  },
  ...
  // ─── HUMANOID (additions) ────────────────────────────────────────────────────
  {
    ...
    buyPath: 'email_required',
    contacts: [
      { label: 'Contact / Partnerships', value: 'apptronik.com', href: 'https://apptronik.com/' },
  ...
  },
  {
    ...
    buyPath: 'direct_online',
    contacts: [
      { label: 'Global Store', value: 'store.agibot.com', href: 'https://store.agibot.com' },
      { label: 'Contact', value: 'agibot.com', href: 'https://www.agibot.com' },
    ],
    products: [
      { name: 'A2 Lite', price: '$44,560', status: 'in_stock', orderUrl: 'https://store.agibot.com', notes: 'Full-size bipedal humanoid; dexterous manipulation; AI-native platform.', image: '/media/AgiBot1.png' },
      { name: 'A2 Ultra', price: 'Quote required', status: 'quote_required', orderUrl: 'https://store.agibot.com', notes: 'Enhanced capability A2 variant.', image: '/media/AgiBot1.png' },
      { name: 'X2', price: '$24,240', status: 'in_stock', orderUrl: 'https://store.agibot.com', notes: 'Half-size humanoid for entertainment and commercial performance. Open-source stack.', image: '/media/AgiBot1.png' },
      { name: 'C5', price: '$32,900', status: 'in_stock', orderUrl: 'https://store.agibot.com', notes: 'Wheeled humanoid platform.', image: '/media/AgiBot1.png' },
      { name: 'D1 Pro (Quadruped)', price: '$3,200', status: 'in_stock', orderUrl: 'https://store.agibot.com', notes: 'Compact quadruped robot.', image: '/media/AgiBot1.png' },
      { name: 'D1 Ultra (Quadruped)', price: '$7,680', status: 'in_stock', orderUrl: 'https://store.agibot.com', notes: 'Industry-leading compact quadruped.', image: '/media/AgiBot1.png' },
    ],
    procurementNotes: 'Formerly Zhiyuan Robotics (backed by Alibaba). Verified global storefront at store.agibot.com ships worldwide (shipping $500–$3,000 extra). 5,168 units shipped in 2025 — #1 globally by volume (Omdia). Widest verified price range of any humanoid lineup ($3.2K–$44.5K+). US enterprise inquiries via CES 2026 contacts.',
  },
  {
    id: 'pal-robotics',
    name: 'PAL Robotics',
  ...
  // ─── INDUSTRIAL / AMR (additions) ───────────────────────────────────────────
  {
    ...
    buyPath: 'raas_only',
    contacts: [
      { label: 'Sales', value: 'locusrobotics.com', href: 'https://locusrobotics.com/' },
  ...
  },
  {
    ...
    contacts: [
      ...
      { label: 'Find Distributor', value: 'automation.omron.com', href: 'https://automation.omron.com/en/us/' },
    ],
    products: [
  ...
  },
  {
    ...
    buyPath: 'raas_only',
    contacts: [
      { label: 'Contact', value: 'ocadointelligentautomation.com/contact', href: 'https://ocadointelligentautomation.com/contact' },
  ...
  },
  {
    ...
    products: [
      { name: 'Autel Alpha', price: '$19,289', status: 'in_stock', orderUrl: 'https://www.autelrobotics.com/productdetail/autel-alpha', notes: 'NEW · Flagship multi-purpose industrial drone. DG-L35T gimbal: 560x hybrid zoom; 4K 35x optical + 56x dual thermal cameras; IP55 rating; dual hot-swappable batteries; 40-min flight time; 20 km range; A-Mesh network; 12 m/s wind resistance; -20°C to 50°C; 4,500 m altitude. Public safety, powerline inspection, SAR.', image: '/media/%20Autel%20Alpha.png' },
      { name: 'Autel Alpha (DG-L35T Config)', price: '$19,289', status: 'in_stock', orderUrl: 'https://www.autelrobotics.com/productdetail/autel-alpha', notes: 'Alpha with DG-L35T gimbal — dual thermal (short + long focal length) + 4K 35x optical + laser rangefinder. 560x super hybrid zoom. Long-range target ID and night ops.', image: '/media/autel-alpha-l35t-333.webp' },
      { name: 'EVO Lite Enterprise Series (6K)', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'Lightweight portable enterprise drone. 40-min flight time; 6K resolution; obstacle avoidance. NDAA compliant.', image: '/media/evo-lite-6k-enterprise-premium-package-745.webp' },
      { name: 'EVO Lite Enterprise Series (640T)', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'EVO Lite Enterprise with 640×512 infrared thermal imaging; 40-min flight time; 6K + thermal dual sensor. NDAA compliant.', image: '/media/evo-lite-640t-enterprise-7-9-premium-package-969.webp' },
      { name: 'EVO Max 4T', price: 'Quote / Contact', status: 'in_stock', orderUrl: 'https://shop.autelrobotics.com', notes: 'A-Mesh network; 720° obstacle avoidance; 42-min flight time; quad-sensor fusion (48MP + thermal + zoom); autonomous flight. NDAA compliant.', image: '/media/%20EVO%20Max%204T.png' },
      { name: 'EVO Max 4T XE Bundle', price: 'Quote / Contact', status: 'in_stock', orderUrl: 'https://shop.autelrobotics.com', notes: 'EVO Max 4T with extended accessories bundle. Includes additional batteries, smart controller, and carry case.', image: '/media/evo-max-4t-xe-bundle-371.webp' },
      { name: 'EVO Max 4N', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'Starlight vision camera; no blind spots; 42-min flight time; night-optimized 4× zoom + thermal. NDAA compliant.', image: '/media/EVO_MAX_4N_Main_05.webp' },
      { name: 'EVO II Pro V3', price: '~$4,499', status: 'in_stock', orderUrl: 'https://shop.autelrobotics.com', notes: '6K Hasselblad-equivalent camera; 42-min flight time; 15 km FCC range; ADS-B receiver; NDAA compliant.', image: '/media/%20EVO%20II%20Pro%20V3.png' },
      { name: 'EVO II Enterprise V3', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'Modular payload system (RGB + thermal options); 15 km FCC range; RTK module compatible; ADS-B signal receiver; 42-min flight time. NDAA compliant.', image: '/media/%20EVO%20II%20Enterpries%20V3.png' },
      { name: 'EVO II Dual 640T V3', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'Dual-sensor 640T thermal + 8K RGB; RTK compatible; centimeter-level positioning; 15 km range. NDAA compliant.', image: '/media/%20EVO%20II%20Dual%20640T%20V3.png' },
      { name: 'EVO II RTK Series V3', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'RTK/PPK precision positioning; centimeter-level accuracy; survey and mapping optimized; 15 km range. NDAA compliant.', image: '/media/%20EVO%20II%20RTK%20Series%20V3.png' },
      { name: 'EVO Lite Enterprise Series', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'Standard EVO Lite Enterprise platform. 40-min flight; 6K; lightweight and portable. NDAA compliant.', image: '/media/%20EVO%20Lite%20Enterprise%20Series.png' },
      { name: 'EVO Nest (Docking Station)', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'Automated docking and charging station for EVO Max series. Enables autonomous recharging, remote deployment, and fleet management without manual intervention. Drone not included.', image: '/media/evo%20max%20nest%20(Drone%20not%20included).webp' },
      { name: 'Dragonfish Standard', price: 'Quote required', status: 'quote_required', orderUrl: 'https://www.autelrobotics.com', notes: 'Fixed-wing VTOL. Rapid deployment; ~120-min flight time; long-range survey and mapping. NDAA compliant.', image: '/media/%20Dragonfish%20Standard.png' },
      { name: 'Dragonfish Pro', price: 'Quote required', status: 'quote_required', orderUrl: 'https://www.autelrobotics.com', notes: 'Enhanced fixed-wing VTOL. ~180-min flight time; LiDAR-capable; extended range inspection and mapping. NDAA compliant.', image: '/media/%20Dragonfish%20Pro.png' },
      { name: 'Dragonfish-25', price: 'Quote required', status: 'quote_required', orderUrl: 'https://www.autelrobotics.com', notes: 'Flagship fixed-wing VTOL. 10-min rapid deployment; 210-min flight time; 220 km flight range; 10 kg payload. NDAA compliant.', image: '/media/%20Dragonfish-25New.png' },
    ],
    procurementNotes: 'NDAA-compliant DJI alternative. US HQ (Bothell, WA). Direct purchase at shop.autelrobotics.com. Enterprise and volume pricing via enterprise@autelrobotics.com. Autel Alpha is the flagship industrial platform as of 2025.',
  },
  {
    id: 'parrot',
    name: 'Parrot',
    ...
    buyPath: 'direct_online',
    contacts: [
      { label: 'Pro Drones', value: 'parrot.com/us', href: 'https://www.parrot.com/us/drones/anafi-usa' },
      { label: 'Contact', value: 'enterprise@parrot.com', href: 'mailto:enterprise@parrot.com' },
      { label: 'US Dealer — DSLRPros', value: '+1-877-299-1075', href: 'https://www.dslrpros.com/parrot-anafi-usa.html' },
    ],
    products: [
      { name: 'ANAFI USA', price: '~$7,000', status: 'in_stock', orderUrl: 'https://www.parrot.com/us/drones/anafi-usa', notes: 'NDAA/TAA compliant; Blue sUAS approved; NATO-approved; US-assembled; IP53; 32× zoom thermal.', image: '/media/Parrot%20ANAFI%20USA%20.png' },
      ...
      { name: 'ANAFI Ai', price: '~$4,500', status: 'in_stock', orderUrl: 'https://www.parrot.com/us/drones/anafi-ai', notes: 'First 4G LTE drone; sub-250 g; 48MP camera; 4K HDR; AI obstacle avoidance; open API.', image: '/media/Parrot%20ANAFI%20USA%20.png' },
    ...
    procurementNotes: 'French company. ANAFI USA: NDAA/TAA compliant, Blue sUAS approved (Defense Innovation Unit), NATO-approved, US-assembled. Used by US Army, law enforcement, emergency response. Direct purchase at parrot.com/us or via DSLRPros/B&H.',
  },
  {
    id: 'percepto',
    name: 'Percepto',
  ...
  },
  {
    ...
    buyPath: 'direct_online',
    contacts: [
      { label: 'Store', value: 'freeflysystems.com', href: 'https://www.freeflysystems.com/' },
  ...
  },
  {
    ...
    products: [
      ...
      // ── ROBOCUT (Wire EDM) ────────────────────────────────────────────────────
      {
        ...
        price: 'Quote (via Methods Machine Tools)',
        status: 'quote_required',
        orderUrl: 'https://www.fanucamerica.com/products/robocut-wire-edm',
      ...
      // ── ROBOSHOT (Electric Injection Molding) ─────────────────────────────────
      {
        ...
        status: 'quote_required',
        orderUrl: 'https://www.fanucamerica.com/products/roboshot-injection-molding-machine',
  ...
  },
  {
    ...
    category: 'cobot',
    buyPath: 'direct_online',
    contacts: [{ label: 'Website', value: 'igus.com/rebel', href: 'https://www.igus.com/automation/rebel-gearbox-system' }],
    products: [
  ...
  },
  {
    ...
    category: 'components',
    buyPath: 'direct_online',
    contacts: [{ label: 'Website', value: 'onrobot.com', href: 'https://onrobot.com/en' }],
    products: [
      { name: 'VGC10 Vacuum Gripper', price: '$3,782', status: 'in_stock', orderUrl: 'https://onrobot.com/en', notes: 'Configurable vacuum cups; 15 kg payload; 360° rotation.', image: '/media/OnRobot-Products_2021.jpg' },
      { name: '2FG7 Parallel Gripper', price: '$4,724', status: 'in_stock', orderUrl: 'https://onrobot.com/en', notes: '7 kg payload; parallel electric gripper; IP67.', image: '/media/OnRobot-Products_2021.jpg' },
      { name: 'RG2 Gripper', price: '$5,580', status: 'in_stock', orderUrl: 'https://onrobot.com/en', notes: '2 kg payload; 0–110 mm stroke; versatile pick-and-place.', image: '/media/OnRobot-Products_2021.jpg' },
      { name: 'RG6 Gripper', price: 'Quote', status: 'quote_required', orderUrl: 'https://onrobot.com/en', notes: '6 kg payload; 0–160 mm stroke; heavy-duty handling.', image: '/media/OnRobot-Products_2021.jpg' },
      { name: 'RG2-FT Force/Torque Gripper', price: '$11,598', status: 'in_stock', orderUrl: 'https://onrobot.com/en', notes: 'Integrated force/torque + proximity sensor; precise assembly.', image: '/media/OnRobot-Products_2021.jpg' },
      { name: 'HEX-E/H Force Torque Sensor', price: 'Quote', status: 'quote_required', orderUrl: 'https://onrobot.com/en', notes: '6-axis force/torque; 6 sensing directions; all major cobot brands.', image: '/media/OnRobot-Products_2021.jpg' },
  ...
  },
  {
    ...
    contacts: [
      ...
      { label: 'Hugo RAS Info', value: 'medtronic.com/surgical-robotics', href: 'https://www.medtronic.com/en-us/healthcare-professionals/specialties/surgical-robotics.html' },
    ],
    products: [
      {
        ...
        status: 'quote_required',
        orderUrl: 'https://www.medtronic.com/en-us/healthcare-professionals/specialties/surgical-robotics/hugo-robotic-assisted-surgery.html',
  ...
  },
  {
    ...
    category: 'surgical',
    buyPath: 'email_required',
    contacts: [{ label: 'Website', value: 'us.cmrsurgical.com', href: 'https://us.cmrsurgical.com/' }],
    products: [
  ...
  },
  {
    ...
    products: [
      ...
      { name: 'CLOi ServeBot 3.0', price: 'Quote', status: 'quote_required', orderUrl: 'https://solutions.lg.com/us/cloi-servebot/lg-ldltr30', notes: 'Model LDLTR30. 4-tray autonomous delivery robot; 40 kg total load (10 kg per tray); extended tray 20.9" × 17.5"; 56 × 137 × 55 cm; 51 kg weight; independent suspension for stable driving; reinforced multi-robot fleet performance; 11-hour continuous operation on full charge; CMS (Cloud Management System) for simultaneous fleet control; status LED (Red/Blue/Green).', image: '/media/CLOi%20ServeBot%203.0.webp' },
    ],
  ...
  },
  {
    ...
    category: 'cleaning',
    buyPath: 'direct_online',
    contacts: [{ label: 'Website', value: 'icecobotics.com', href: 'https://www.icecobotics.com/' }],
    products: [
      { name: 'Cobi 18 Autonomous Scrubber', price: '$16,000/36-mo subscription (~$15/day)', status: 'raas', orderUrl: 'https://www.icecobotics.com/cobi-18/', image: '/media/ICE%20Cobotics.png' },
    ],
  ...
  // ─── QUADRUPED ───────────────────────────────────────────────────────────────
  {
    ...
    products: [
      ...
      { name: 'Go2 Air', price: '$1,600', status: 'in_stock', orderUrl: 'https://shop.unitree.com', notes: 'Entry-level; AI-capable; 4D LiDAR option.' },
      { name: 'Go2 Pro', price: '$2,800', status: 'in_stock', orderUrl: 'https://shop.unitree.com', notes: 'Advanced navigation; wider sensor suite.' },
      { name: 'Go2 X', price: '$5,990', status: 'in_stock', orderUrl: 'https://shop.unitree.com', notes: 'Top consumer quadruped; full LiDAR + computing.' },
      { name: 'Go2 EDU', price: '$13,999+', status: 'in_stock', orderUrl: 'https://shop.unitree.com', notes: 'Research/education platform; SDK + ROS2 + optional arm attachment.' },
  ...
  // ─── AGRICULTURAL ────────────────────────────────────────────────────────────
  {
    ...
    buyPath: 'email_required',
    contacts: [{ label: 'Website', value: 'monarchtractor.com', href: 'https://www.monarchtractor.com/' }],
    products: [
  ...
  },
  {
    ...
    category: 'agricultural',
    buyPath: 'dealer_only',
    contacts: [{ label: 'Website', value: 'ag.dji.com', href: 'https://ag.dji.com/' }],
    products: [
      { name: 'Agras T20P', price: '$10,499', status: 'not_available', orderUrl: 'https://ag.dji.com/t20p', notes: 'Smart farming; intelligent spray systems; lightweight design; perfect for beginners or veterans. 20 kg spray payload; 25 kg (35 L) spread payload; quad-rotor tilted truss design; folds 77% smaller; Dual Atomized Spraying System; Active Phased Array Radar + Binocular Vision; IPX6K; DJI Terra mapping.', image: '/media/dji-agras-t20p.png' },
      { name: 'Agras T25', price: '$10,999', status: 'not_available', orderUrl: 'https://ag.dji.com/t25', notes: 'Spot spraying & small-field operations; single-operator; longer battery life; quicker charging. 20 L tank; 16-nozzle system.', image: '/media/DJI Agras T25.webp' },
      { name: 'Agras T40', price: '$13,499', status: 'not_available', orderUrl: 'https://ag.dji.com/t40', notes: 'Proven leader with millions of acres sprayed; dependable powertrain; choice of custom applicators. 40 kg spray payload; 50 kg (70 L) spread payload; Coaxial Twin Rotor design; Dual Atomized Spraying System; Active Phased Array Radar + Binocular Vision; Core Modules IPX6K; EFI Generator (15% fuel saving); DJI Terra mapping.', image: '/media/DJI Agras T40.webp' },
      { name: 'Agras T50', price: '$30,999', status: 'in_stock', orderUrl: 'https://ag.dji.com/t50', notes: '40 L tank; 16-nozzle; dual atomizing; 50 kg MTOW; large farms.', image: '/media/DJI Agras T50.webp' },
    ],
  ...
  },
  {
    ...
    contacts: [
      { label: 'Website', value: 'swarmfarm.com', href: 'https://www.swarmfarm.com/' },
    ],
    products: [
      {
  ...
  },
  {
    ...
    category: 'inspection',
    buyPath: 'email_required',
    contacts: [{ label: 'Website', value: 'ondas.com/airobotics', href: 'https://www.ondas.com/airobotics' }],
    products: [
    ...
    procurementNotes: 'Now part of Ondas Autonomous Systems (Nasdaq: ONDS). Automated drone-in-a-box for oil/gas, port, and industrial inspection. BVLOS authorized.',
  },
  ...
  },
  {
    ...
    category: 'exoskeleton',
    buyPath: 'raas_only',
    contacts: [{ label: 'Website', value: 'palladyneai.com', href: 'https://www.palladyneai.com/' }],
    products: [
      { name: 'Guardian XO (full-body, 200 lb lift assist)', price: 'Discontinued', status: 'not_available', image: '/media/Guardian%20XO.avif' },
      { name: 'Guardian XT (upper body)', price: 'Discontinued', status: 'not_available', image: '/media/Guardian%20XO.avif' },
    ],
    procurementNotes: 'Sarcos rebranded to Palladyne AI (Nasdaq: PDYN) and pivoted from hardware to AI software. Guardian XO/XT exoskeleton hardware lines have been discontinued. Inquiries via palladyneai.com.',
  },
  {
    id: 'german-bionic',
    name: 'German Bionic',
  ...
  },
  {
    ...
    category: 'defense',
    buyPath: 'email_required',
    contacts: [{ label: 'Website', value: 'defense.flir.com', href: 'https://defense.flir.com/' }],
    products: [
  ...
  },
  {
    ...
    category: 'defense',
    buyPath: 'email_required',
    contacts: [{ label: 'Website', value: 'milremrobotics.com', href: 'https://milremrobotics.com/' }],
    products: [
  ...
  },
  {
    ...
    buyPath: 'dealer_only',
    contacts: [
      { label: 'Website', value: 'pudurobotics.com', href: 'https://www.pudurobotics.com/en' },
      { label: 'Contact', value: 'pudurobotics.com/contact-us', href: 'https://www.pudurobotics.com/en/contact-us' },
    ],
    products: [
      { name: 'PUDU BG1 Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · AI-Native Large Scrubber-Dryer Robot. One-Pass Sweep & Scrub; Extendable Edge Cleaning; AI Magic Cleaning; 3D Perception Enhancement; 24/7 Continuous Operation.', image: '/media/nav_product_BG_1_Pro.png' },
      { name: 'PUDU BG1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · AI-Native Large Scrubber-Dryer Robot. One-Pass Sweep & Scrub; Extendable Edge Cleaning; AI Magic Cleaning; 3D Perception Enhancement; Instant User-friendly Maintenance; 24/7 Continuous Operation.', image: '/media/nav_product_BG_1.png' },
      { name: 'PUDU T150', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · Light-payload Industrial Delivery Robot. Rapid Deployment in 1 Hour; Precision Navigation & Stability; Aerospace-Grade Unibody Design; Intuitive Operation; Adaptability in Complex Environments; 24/7 Continuous Operation.', image: '/media/nav_product_T150_b09ac8e95b.png' },
      { name: 'PUDU D5 Series', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · Industry-Grade Autonomous Quadruped Robot. NVIDIA-Powered Computing Platform; 360° Perception for Safety Assurance; All-Terrain Mobility; All-Weather Adaptability; Intuitive Voice & Gesture Interaction; Compatible with Multiple Peripherals.', image: '/media/pudu%20d5%20series.png' },

      { name: 'PUDU T600', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · Heavy-payload Industrial Delivery Robot. 600 kg Payload Capacity; Two Modes Freely Selectable; Rack Group Recognition; VDA5050 Protocol; Idle Elevator Priority Scheduling; On-premises Deployment.', image: '/media/pudu%20t600.png' },
      { name: 'PUDU T600 Underride', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · Flexible & Efficient Industrial Delivery Platform. 600 kg Payload Capacity; Two Modes Freely Selectable; Rack Group Recognition; VDA5050 Protocol; Idle Elevator Priority Scheduling; On-premises Deployment.', image: '/media/pudu%20t600.png' },
      { name: 'PUDU CC1 Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'HOT · AI-powered Autonomous Cleaning Robot. AI Spot Scrubbing; AI Real-Time Cleaning Performance Detection; AI Cleaning Intensity Control; AI Components Self-Monitoring; 4-in-1 Versatile Cleaning; VSLAM+ Positioning; 360° Omni-Sense Safety; IEC 63327 Certified.', image: '/media/nav_product_cc1_Pro_7de75f36ae.png' },
      { name: 'FlashBot Arm', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · Semi-Humanoid Embodied AI Service Robot. Intelligent Decision Making; Autonomous Operation; Dual Arms & Dexterous Hands; Proactively Adapt to Scenarios; Multiple Security Protections; Multimodal Natural Interaction.', image: '/media/nav_product_flashbot_arm_58961abf05.png' },
      { name: 'PUDU D9', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · Full-Size Biped Humanoid Robot. Human-like Bipedal Design; Visual Semantic Navigation; High Payload Bionic Arm; Scalable End-to-end Capability; Multi-modal High-precision Perception; Natural Human-Robot Interaction.', image: '/media/nav_pudu_d9_baa71e3b5b.png' },
      { name: 'PUDU D7', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'NEW · First-Generation Semi-Humanoid Robot. High-Performance Computing Platform; Omnidirectional Chassis; High-Accuracy Positioning & Navigation; High DOF Mobility; Multimodal Perception; Generalized Learning Operations; High Payload Bionic Arm; Hybrid Control.', image: '/media/nav_PUDU_D7_114b122fa9.png' },
      { name: 'FlashBot Max', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'HOT · Building Delivery Expert. VSLAM+ Semi-outdoor Delivery; Cloud & Hardware Solutions for Elevator Control; AI Voice Interaction; Full-Scope IoT Integration; Remote Reset; Modular Adjustable Compartments.', image: '/media/nav_flashbot_new_e3c621b5fd.png' },
      { name: 'PUDU MT1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'AI Powered Robotic Sweeper. No Debris Too Big or Small; AI Trash Recognition; AI Spot Cleaning; Rapid Adaptation to Changing Environments; 24/7 Continuous Operation; User-Friendly Design.', image: '/media/nav_product_MT1_9d40c8e237.webp' },
      { name: 'PUDU SH1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'Smart Upright Scrubber Dryer. Air-liquid-debris Separation; Measurable Cleaning; Smart Touch Screen Interface; Real-time Components Monitoring; Built for Stubborn Stains; Multi-dimensional Cleaning.', image: '/media/Pudu%20sh1.png' },

      { name: 'BellaBot Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'HOT · Premium Delivery & Advertising Robot. Upgraded VSLAM+; AI Voice Interaction; Superior Mobility; Customized Advertisement capability.', image: '/media/nav_product_bella_pro_816bfa936e.png' },
      { name: 'KettyBot Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'HOT · Flexible Multitasker. 18.5" Display for Customized Advertisement; Superior Mobility; Multiple Delivery Modes; Smart Tray Detection; Automatic Recharging.', image: '/media/nav_product_kettybotpro_64d5202d1a.png' },
      { name: 'PUDU CC1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'Intelligent Commercial Cleaning Robot. 4-in-1 Versatile Cleaning; Auto Power Charging & Water Refill; IoT Capabilities; Diversified Consumables; Mobile Water Tank — No Plumbing Modification; Dynamic Space Perception.', image: '/media/nav_product_cc1_8baf7f1424.png' },
      { name: 'BellaBot', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'Premium Delivery Robot. Multimodal Interaction; Power Exchange Technology; High-sense Obstacle Avoidance; Intelligent Multifunctional Delivery; Dual SLAM Technology.', image: '/media/nav_product_bellabot_f807eb57b5.png' },
      { name: 'PuduBot 2', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'Universal Delivery Robot. Marker-less Deployment; Various Forms & Accessories; Auto-charging; Fully Enclosed Machine Design; Greater Environmental Adaptability.', image: '/media/nav_product_pudubot2_478d35cdae.png' },
      { name: 'PUDU HolaBot', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/en/products', notes: 'Pager & Notification Delivery Robot. High Loading Capacity; Pager & Notifications; Sound Tracking; 3D Obstacle Avoidance Technology; Autonomous Navigation Planning.', image: '/media/nav_product_holabot_f0fafd284d.png' },
    ],
  ...
  },
  {
    ...
    contacts: [
      ...
      { label: 'Build', value: 'artly.ai', href: 'https://www.artly.ai/' },
    ],
    products: [
    ...
    procurementNotes: 'Legal name: Blue Hill Tech, Inc. (Seattle, WA; founded 2020). Two business arms: artly.coffee (consumer/event service) and artly.ai (Physical AI training platform; buildwithartly.com now redirects to artly.ai). B2B partnerships and venue placements via the artly.coffee site.',
  },
  {
    id: 'zikoo',
    name: 'Zikoo Robotics',
