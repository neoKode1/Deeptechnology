...
export const VENDORS: Vendor[] = [
  ...
  },
  {
    ...
    products: [
      { name: 'Autel Alpha', price: '$19,289', status: 'in_stock', orderUrl: 'https://www.autelrobotics.com/productdetail/autel-alpha', notes: 'NEW · Flagship multi-purpose industrial drone. DG-L35T gimbal: 560x hybrid zoom; 4K 35x optical + 56x dual thermal cameras; superior anti-interference; IP55 rating; dual hot-swappable batteries; 40-min flight time; 20 km transmission range; A-Mesh network; 12 m/s wind resistance; -20°C to 50°C; 4,500 m altitude; 6,480 g MTOW. Designed for public safety, powerline inspection, SAR.', image: '/media/%20Autel%20Alpha.png' },
      { name: 'Autel Alpha (DG-L35T Config)', price: '$19,289', status: 'in_stock', orderUrl: 'https://www.autelrobotics.com/productdetail/autel-alpha', notes: 'Alpha configured with DG-L35T gimbal — dual thermal (short + long focal length) + 4K 35x optical zoom + laser rangefinder. 560x super hybrid zoom. Ideal for long-range target identification and night ops.', image: '/media/autel-alpha-l35t-333.webp' },
      { name: 'EVO Lite Enterprise Series', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'Lightweight and portable enterprise drone. 40-min flight time; 6K resolution; 640×512 infrared thermal imaging. NDAA compliant.', image: '/media/Autel%20Robotics.jpg' },
      { name: 'EVO Max 4T', price: 'Quote / Contact', status: 'in_stock', orderUrl: 'https://shop.autelrobotics.com', notes: 'A-Mesh network; 720° obstacle avoidance; 42-min flight time; quad-sensor fusion (48MP + thermal + zoom); autonomous flight. NDAA compliant.', image: '/media/Autel%20Robotics.jpg' },
      { name: 'EVO Max 4N', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'Starlight vision camera; no blind spots; 42-min flight time; night-optimized 4× zoom + thermal. NDAA compliant.', image: '/media/Autel%20Robotics.jpg' },
      { name: 'EVO II Enterprise V3', price: '~$4,499', status: 'in_stock', orderUrl: 'https://shop.autelrobotics.com', notes: '9.3 mi / 15 km FCC range; RTK module compatible; ADS-B signal receiver; 42-min flight time; modular payload (RGB + thermal). NDAA compliant.', image: '/media/Autel%20Robotics.jpg' },
      { name: 'EVO II Dual 640T V3', price: 'Quote required', status: 'quote_required', orderUrl: 'https://shop.autelrobotics.com', notes: 'RTK compatible; centimeter-level positioning; dual-sensor 640T thermal + RGB; 15 km range. NDAA compliant.', image: '/media/Autel%20Robotics.jpg' },
      { name: 'Dragonfish-25', price: 'Quote required', status: 'quote_required', orderUrl: 'https://www.autelrobotics.com', notes: 'Fixed-wing VTOL. 10-min rapid deployment; 210-min flight time; 220 km flight range; 10 kg payload. Long-range survey, mapping, and inspection. NDAA compliant.', image: '/media/Autel%20Robotics.jpg' },
    ],
    procurementNotes: 'NDAA-compliant DJI alternative. US HQ (Bothell, WA). Consumer/prosumer drones at shop.autelrobotics.com. Enterprise and volume pricing via enterprise@autelrobotics.com. Autel Alpha is the flagship industrial platform as of 2025.',
  },
  {
    id: 'parrot',
    name: 'Parrot',
