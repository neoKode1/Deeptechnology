...
export const VENDORS: Vendor[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: 'DFR Command (Software)', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.skydio.com/dfr-command', notes: 'Drone as First Responder command and control software. Integrates with CAD/dispatch systems; real-time video streaming; fleet management for public safety agencies.', image: '/media/Skydio.avif' },
      { name: 'Remote Ops (Software)', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.skydio.com/remote-ops', notes: 'Remote operations platform. Control Skydio drones and Docks from anywhere; live video feeds; mission planning; data export to downstream workflows.', image: '/media/Skydio.avif' },
      { name: '3D Scan (Software)', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.skydio.com/3d-scan', notes: 'Automated 3D scanning software. AI-driven flight paths capture complete photogrammetric datasets of structures, infrastructure, and terrain. Integrates with Autodesk, Bentley, and other platforms.', image: '/media/Skydio.avif' },
    ],
  ...
  },
  {
    ...
    products: [
      { name: 'BellaBot', price: '$15,900', status: 'in_stock', orderUrl: 'https://pudurobotics.com', notes: '40 kg capacity; 4-tray; dual SLAM; restaurant delivery.', image: '/media/nav_product_bellabot_f807eb57b5.png' },
      { name: 'BellaBot Pro', price: '$16,900', status: 'in_stock', orderUrl: 'https://pudurobotics.com', notes: 'VSLAM+; dual advertising displays; 65 cm path clearance.', image: '/media/nav_product_bella_pro_816bfa936e.png' },
      { name: 'KettyBot', price: 'Quote', status: 'quote_required', orderUrl: 'https://pudurobotics.com', notes: '30 kg capacity; 3-in-1 delivery + reception + promotion robot.' },
      { name: 'KettyBot Pro', price: '$12,000', status: 'in_stock', orderUrl: 'https://pudurobotics.com', notes: 'Enhanced AI voice interaction; advanced 3-in-1 functionality.', image: '/media/nav_product_kettybotpro_64d5202d1a.png' },
      { name: 'HolaBot', price: 'Quote', status: 'quote_required', orderUrl: 'https://pudurobotics.com', notes: 'Large-capacity tray delivery; 60 kg total load; dirty-dish collection.', image: '/media/nav_product_holabot_f0fafd284d.png' },
      { name: 'FlashBot', price: 'Quote', status: 'quote_required', orderUrl: 'https://pudurobotics.com', notes: 'Closed-compartment delivery; 4 lockable compartments; hotel rooms, offices.', image: '/media/nav_flashbot_new_e3c621b5fd.png' },
      { name: 'PuduBot 2', price: 'Quote', status: 'quote_required', orderUrl: 'https://pudurobotics.com', notes: 'Mid-size restaurant delivery robot; multi-layer tray; 9 h runtime.', image: '/media/nav_product_pudubot2_478d35cdae.png' },
      { name: 'SwiftBot', price: 'Quote', status: 'quote_required', orderUrl: 'https://pudurobotics.com', notes: 'Compact fast delivery robot; high throughput, tight spaces.' },
      { name: 'T300 Lift', price: '$21,000', status: 'in_stock', orderUrl: 'https://pudurobotics.com', notes: 'Industrial lift transport; 300 kg payload; manufacturing + warehouse.', image: '/media/pudu%20t600.png' },
    ],
  ...
  },
  {
    ...
    buyPath: 'dealer_only',
    contacts: [
      { label: 'Website', value: 'pudurobotics.com', href: 'https://www.pudurobotics.com' },
      { label: 'Contact', value: 'pudurobotics.com/contact', href: 'https://www.pudurobotics.com/contact-us' },
    ],
    products: [
      { name: 'PUDU BG1 Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · AI-Native Large Scrubber-Dryer Robot. One-Pass Sweep & Scrub; Extendable Edge Cleaning; AI Magic Cleaning; 3D Perception Enhancement; 24/7 Continuous Operation.', image: '/media/nav_product_BG_1_Pro.png' },
      { name: 'PUDU BG1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · AI-Native Large Scrubber-Dryer Robot. One-Pass Sweep & Scrub; Extendable Edge Cleaning; AI Magic Cleaning; 3D Perception Enhancement; Instant User-friendly Maintenance; 24/7 Continuous Operation.', image: '/media/nav_product_BG_1.png' },
      { name: 'PUDU T150', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · Light-payload Industrial Delivery Robot. Rapid Deployment in 1 Hour; Precision Navigation & Stability; Aerospace-Grade Unibody Design; Intuitive Operation; Adaptability in Complex Environments; 24/7 Continuous Operation.', image: '/media/nav_product_T150_b09ac8e95b.png' },
      { name: 'PUDU D5 Series', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · Industry-Grade Autonomous Quadruped Robot. NVIDIA-Powered Computing Platform; 360° Perception for Safety Assurance; All-Terrain Mobility; All-Weather Adaptability; Intuitive Voice & Gesture Interaction; Compatible with Multiple Peripherals.', image: '/media/pudu%20d5%20series.png' },

      { name: 'PUDU T600', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · Heavy-payload Industrial Delivery Robot. 600 kg Payload Capacity; Two Modes Freely Selectable; Rack Group Recognition; VDA5050 Protocol; Idle Elevator Priority Scheduling; On-premises Deployment.', image: '/media/pudu%20t600.png' },
      { name: 'PUDU T600 Underride', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · Flexible & Efficient Industrial Delivery Platform. 600 kg Payload Capacity; Two Modes Freely Selectable; Rack Group Recognition; VDA5050 Protocol; Idle Elevator Priority Scheduling; On-premises Deployment.', image: '/media/pudu%20t600.png' },
      { name: 'PUDU CC1 Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'HOT · AI-powered Autonomous Cleaning Robot. AI Spot Scrubbing; AI Real-Time Cleaning Performance Detection; AI Cleaning Intensity Control; AI Components Self-Monitoring; 4-in-1 Versatile Cleaning; VSLAM+ Positioning; 360° Omni-Sense Safety; IEC 63327 Certified.', image: '/media/nav_product_cc1_Pro_7de75f36ae.png' },
      { name: 'FlashBot Arm', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · Semi-Humanoid Embodied AI Service Robot. Intelligent Decision Making; Autonomous Operation; Dual Arms & Dexterous Hands; Proactively Adapt to Scenarios; Multiple Security Protections; Multimodal Natural Interaction.', image: '/media/nav_product_flashbot_arm_58961abf05.png' },
      { name: 'PUDU D9', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · Full-Size Biped Humanoid Robot. Human-like Bipedal Design; Visual Semantic Navigation; High Payload Bionic Arm; Scalable End-to-end Capability; Multi-modal High-precision Perception; Natural Human-Robot Interaction.', image: '/media/nav_pudu_d9_baa71e3b5b.png' },
      { name: 'PUDU D7', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · First-Generation Semi-Humanoid Robot. High-Performance Computing Platform; Omnidirectional Chassis; High-Accuracy Positioning & Navigation; High DOF Mobility; Multimodal Perception; Generalized Learning Operations; High Payload Bionic Arm; Hybrid Control.', image: '/media/nav_PUDU_D7_114b122fa9.png' },
      { name: 'FlashBot Max', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'HOT · Building Delivery Expert. VSLAM+ Semi-outdoor Delivery; Cloud & Hardware Solutions for Elevator Control; AI Voice Interaction; Full-Scope IoT Integration; Remote Reset; Modular Adjustable Compartments.', image: '/media/nav_flashbot_new_e3c621b5fd.png' },
      { name: 'PUDU MT1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'AI Powered Robotic Sweeper. No Debris Too Big or Small; AI Trash Recognition; AI Spot Cleaning; Rapid Adaptation to Changing Environments; 24/7 Continuous Operation; User-Friendly Design.', image: '/media/nav_product_MT1_9d40c8e237.webp' },
      { name: 'PUDU SH1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'Smart Upright Scrubber Dryer. Air-liquid-debris Separation; Measurable Cleaning; Smart Touch Screen Interface; Real-time Components Monitoring; Built for Stubborn Stains; Multi-dimensional Cleaning.', image: '/media/Pudu%20sh1.png' },

      { name: 'BellaBot Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'HOT · Premium Delivery & Advertising Robot. Upgraded VSLAM+; AI Voice Interaction; Superior Mobility; Customized Advertisement capability.', image: '/media/nav_product_bella_pro_816bfa936e.png' },
      { name: 'KettyBot Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'HOT · Flexible Multitasker. 18.5" Display for Customized Advertisement; Superior Mobility; Multiple Delivery Modes; Smart Tray Detection; Automatic Recharging.', image: '/media/nav_product_kettybotpro_64d5202d1a.png' },
      { name: 'PUDU CC1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'Intelligent Commercial Cleaning Robot. 4-in-1 Versatile Cleaning; Auto Power Charging & Water Refill; IoT Capabilities; Diversified Consumables; Mobile Water Tank — No Plumbing Modification; Dynamic Space Perception.', image: '/media/nav_product_cc1_8baf7f1424.png' },
      { name: 'BellaBot', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'Premium Delivery Robot. Multimodal Interaction; Power Exchange Technology; High-sense Obstacle Avoidance; Intelligent Multifunctional Delivery; Dual SLAM Technology.', image: '/media/nav_product_bellabot_f807eb57b5.png' },
      { name: 'PuduBot 2', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'Universal Delivery Robot. Marker-less Deployment; Various Forms & Accessories; Auto-charging; Fully Enclosed Machine Design; Greater Environmental Adaptability.', image: '/media/nav_product_pudubot2_478d35cdae.png' },
      { name: 'PUDU HolaBot', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'Pager & Notification Delivery Robot. High Loading Capacity; Pager & Notifications; Sound Tracking; 3D Obstacle Avoidance Technology; Autonomous Navigation Planning.', image: '/media/nav_product_holabot_f0fafd284d.png' },
    ],
