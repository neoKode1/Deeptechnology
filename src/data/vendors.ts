...
export const VENDORS: Vendor[] = [
  ...
  },
  {
    ...
    products: [
      { name: 'PUDU BG1 Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · AI-Native Large Scrubber-Dryer Robot. One-Pass Sweep & Scrub; Extendable Edge Cleaning; AI Magic Cleaning; 3D Perception Enhancement; 24/7 Continuous Operation.', image: '/media/Pudu%20sh1.png' },
      { name: 'PUDU BG1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · AI-Native Large Scrubber-Dryer Robot. One-Pass Sweep & Scrub; Extendable Edge Cleaning; AI Magic Cleaning; 3D Perception Enhancement; Instant User-friendly Maintenance; 24/7 Continuous Operation.', image: '/media/Pudu%20sh1.png' },
      { name: 'PUDU T150', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · Light-payload Industrial Delivery Robot. Rapid Deployment in 1 Hour; Precision Navigation & Stability; Aerospace-Grade Unibody Design; Intuitive Operation; Adaptability in Complex Environments; 24/7 Continuous Operation.', image: '/media/pudu%20t600.png' },
      ...
      { name: 'PUDU MT1 Max', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'NEW · AI-powered 3D Perception Robotic Sweeper. 3D Perception Integration; Magic Cleaning; Intelligent Active Interaction; Covers Up to 100,000㎡; 24/7 Continuous Operation.', image: '/media/Pudu%20sh1.png' },
      ...
      { name: 'PUDU MT1 Vac', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'HOT · AI-powered Robotic Sweeper & Vacuum. Powerful Suction; High Efficiency; Extended Run-time; AI-driven Adaptive Cleaning; Quick-Release Dust Mop Module; Hand-vacuum Extension.', image: '/media/Pudu%20sh1.png' },
      { name: 'PUDU CC1 Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'HOT · AI-powered Autonomous Cleaning Robot. AI Spot Scrubbing; AI Real-Time Cleaning Performance Detection; AI Cleaning Intensity Control; AI Components Self-Monitoring; 4-in-1 Versatile Cleaning; VSLAM+ Positioning; 360° Omni-Sense Safety; IEC 63327 Certified.', image: '/media/Pudu%20sh1.png' },
      ...
      { name: 'PUDU MT1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'AI Powered Robotic Sweeper. No Debris Too Big or Small; AI Trash Recognition; AI Spot Cleaning; Rapid Adaptation to Changing Environments; 24/7 Continuous Operation; User-Friendly Design.', image: '/media/Pudu%20sh1.png' },
      ...
      { name: 'PUDU T300', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'HOT · Industrial Delivery Robot. 300 kg Load Capacity; Flexible VSLAM+ Positioning; Omnidirectional Perception; 24/7 Non-stop Operation; Diversified Application Series; ISO 3691-4 Standard; 60 cm Path Clearance.', image: '/media/pudu%20t600.png' },
      { name: 'BellaBot Pro', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'HOT · Premium Delivery & Advertising Robot. Upgraded VSLAM+; AI Voice Interaction; Superior Mobility; Customized Advertisement capability.', image: '/media/PUDU%20Robotics-Bellabot-1-2.webp' },
      ...
      { name: 'PUDU CC1', price: 'Quote', status: 'quote_required', orderUrl: 'https://www.pudurobotics.com/products', notes: 'Intelligent Commercial Cleaning Robot. 4-in-1 Versatile Cleaning; Auto Power Charging & Water Refill; IoT Capabilities; Diversified Consumables; Mobile Water Tank — No Plumbing Modification; Dynamic Space Perception.', image: '/media/Pudu%20sh1.png' },
